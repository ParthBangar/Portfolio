            ...
            <div className='flex flex-col lg:flex-row  justify-between items-center gap-4 m-2 p-2 border-2 border-[#33333330] rounded-md h-full'>
                ...
                <div className='flex-1'>
                    <div className='flex justify-center items-center bg-white border-2 border-gray-100 rounded-md shadow-2xl p-4'>
                        <img src="https://i.ibb.co/HLLVWr5k/Movie-Flex.png" alt="" className='w-[320px] rounded-md' />
                    </div>
                </div>
                ...
                <div className='flex-1'>
                    ...
                    <p className='text-xl text-justify p-2'>Developed MovieFlix, a modern movie information dashboard using React and Redux Toolkit, integrating external APIs to provide real-time movie details with efficient state management.</p>
